...
@Module({
  ...
  providers: [JwtService, FileService, ImageService, DashboardGateway, DocsGateway, TreeGateway, ExportService, BlueprintRepository, DocumentRepository, NodeRepository, RelationshipRepository],
})
