export enum Flags {
  ...
  COLOR_BLUEPRINT = "COLOR_BLUEPRINT",
  TAG_ADD_BLUEPRINT = "TAG_ADD_BLUEPRINT",
  TAG_REMOVE_BLUEPRINT = "TAG_REMOVE_BLUEPRINT",
  CREATE_NODE = "CREATE_NODE",
  REMOVE_NODE = "REMOVE_NODE",
  LOCK_NODE = "LOCK_NODE",
  PLACE_NODE = "PLACE_NODE",
  SUMARRY_NODE = "SUMARRY_NODE",
  PLACE_RELATIONSHIP = "PLACE_RELATIONSHIP",
  CREATE_RELATION = "CREATE_RELATION",
  REMOVE_RELATION = "REMOVE_RELATION",

  SEND_SHEET = "SEND_SHEET",
